...
const Editor: React.FC<EditorProps> = ({
    ...
    const handleKeyDown = (e: React.KeyboardEvent) => {
        ...
        // Backspace at start of a page-break page: remove the break, allow content to flow back
        if (e.key === 'Backspace' && !e.metaKey && !e.ctrlKey) {
            const sel = window.getSelection();
            if (sel && sel.rangeCount > 0 && sel.getRangeAt(0).collapsed && sel.getRangeAt(0).startOffset === 0) {
