...
const Sidebar: React.FC<SidebarProps> = ({ pageCount, currentPage, onPageSelect }) => {
  return (
    <div className="w-64 border-r border-gray-200 bg-white h-[calc(100vh-64px)] overflow-y-auto hidden lg:block flex-shrink-0">
